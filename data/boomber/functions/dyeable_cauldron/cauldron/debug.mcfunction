...
setblock ~ 255 ~ oak_sign{Text1: '[{"text": "Dyes: "}, {"nbt": "ArmorItems[-1].tag.ctc.dyeable_cauldron.dyes", "entity": "@e[type=armor_stand, tag=boomber.dyeable_cauldron.cauldron.displaying, limit=1]"}]'}
